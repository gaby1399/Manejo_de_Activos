...
namespace Infraestructure.Utils
{
    class Log
    {
        ...
        public static void Error(System.Exception exception, MethodBase methodBase)
        {
            string dummy = "";
            // Invoca a Error y se le pasa una dummy string
            Error(exception, methodBase, ref dummy);
        }
        ...
        public static void Error(System.Exception exception, MethodBase methodBase, ref string pMensaje)
        {
            ...
            if (exception is DbUpdateException)
            {
                ...
                _instance.monitoringLogger.Error(msg.ToString());
            }
            else
            {
